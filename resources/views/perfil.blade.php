            ...
            <div class="mx-auto w-full max-w-lg">
                ...
                <div class="bg-white px-8 py-10 rounded-2xl shadow-xl border border-gray-100">
                    <div class="flex flex-col items-center mb-8">
                        <div
                            class="w-24 h-24 rounded-full bg-emerald-100 flex items-center justify-center mb-4 ring-4 ring-white shadow">
                    ...
                    @if (session('status'))
                        <div
                            class="mb-6 px-4 py-3 text-base text-emerald-700 bg-emerald-50 border border-emerald-100 rounded-lg flex items-center gap-2">
                    ...
                    <div class="mt-10 pt-8 border-t border-gray-100">
                        ...
                        <button type="button" onclick="document.getElementById('deleteModal').classList.remove('hidden')"
                            class="flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-red-600 border border-red-600 rounded-2xl bg-white hover:bg-red-500 hover:text-white hover:shadow-sm hover:scale-[1.01] transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-red-200">
