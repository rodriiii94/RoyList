    ...
    <div class="container mx-auto px-6">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-12 mt-12">
                <h1 class="text-3xl sm:text-4xl font-bold text-gray-800 dark:text-gray-100 mb-4">Términos de Servicio</h1>
                <p class="text-gray-600 dark:text-gray-300">Última actualización: 16 de mayo de 2025</p>
            </div>
            ...
            <div class="prose prose-lg max-w-none text-gray-700 dark:text-gray-200">
                ...
                {{-- Sección 1 --}}
                <div class="mb-8">
                    <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">1. Uso de la Aplicación</h2>
                    <p class="mb-4">
                ...
                {{-- Sección 2 --}}
                <div class="mb-8">
                    <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">2. Registro y Seguridad</h2>
                    <p>
                ...
                {{-- Sección 3 --}}
                <div class="mb-8">
                    <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">3. Contenido del Usuario</h2>
                    <p>
                ...
                {{-- Sección 4 --}}
                <div class="mb-8">
                    <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">4. Disponibilidad del Servicio</h2>
                    <p>
                ...
                {{-- Sección 5 --}}
                <div class="mb-8">
                    <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">5. Modificaciones</h2>
                    <p>
